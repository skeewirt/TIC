// __ZL12scrollupdownP9COMRECORDPiS1_S1_ @ 0x94508 (520 bytes)
...
void *__fastcall scrollupdown(int a1, int *a2, _DWORD *a3)
{
  ...
  v4 = *(__int16 **)(a1 + 48);
  v7 = (_DWORD *)Wimport_localpad(0);
  v8 = (_DWORD *)Wimport_localpad(1);
  v9 = *(_WORD *)(a1 + 6);
  v16 = *(_WORD *)a1;
  v17 = *(_WORD *)(a1 + 2);
  v18 = *(__int16 *)(a1 + 4) >> 2;
  ...
  {
    v19 = v9;
    if ( (*v8 & 0x80) != 0 || *((_DWORD *)wasmtaskframeptr + 256 * wasmtasknumber + 24) )
    {
      if ( (*v7 & 0x1000) != 0 && *a2 )
      {
        v10 = *a2 - *v4;
...
LABEL_13:
        wsoundf = 3;
LABEL_16:
        memset(&optionbuffer, 0, *(__int16 *)(a1 + 6) * *(__int16 *)(a1 + 4) / 2);
      ...
      v13 = (char *)wasmtaskframeptr + 1024 * wasmtasknumber;
      if ( *((_DWORD *)v13 + 24) )
      {
        *((_DWORD *)v13 + 24) = 0;
        goto LABEL_16;
