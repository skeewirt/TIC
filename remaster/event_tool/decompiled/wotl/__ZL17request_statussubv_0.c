// __ZL17request_statussubv_0 @ 0x5DF60 (768 bytes)
...
void __fastcall __noreturn request_statussub()
{
  ...
  {
    Input1 = asmGetInput1();
    *((_DWORD *)&asmtaskframe + 256 * asmtasknumber) = 255;
    lastrequestno = Input1;
    var40[0] = 0;
    v1 = 1;
      ...
      if ( *((_DWORD *)v6 + 18) )
      {
        ...
        switch ( v7 )
        {
          case 17:
            ...
            v9 = (__int16 *)&personalinfo;
            break;
          case 58:
            v8 = (unsigned __int16)lastid2;
            v9 = (__int16 *)&personalinfo2;
            break;
          case 20:
            v8 = (unsigned __int16)lastid1;
            v9 = (__int16 *)&personalinfo;
...
LABEL_14:
          var40[v5] = 1;
          send_taskparamater(v5, 0, 0, 1);
        }
      }
      else if ( *(_DWORD *)v4 != -1 )
      {
        task_create(v5, *(void (__fastcall **)())v4);
        send_taskparamater(*((_DWORD *)v4 + 4), 0, 0, 0);
...
LABEL_20:
    ...
    for ( i = 0; i != 4; ++i )
    {
      ...
      {
        task_create(v14, *(void (__fastcall **)())v3);
        send_taskparamater(*((_DWORD *)v3 + 4), 0, 0, 0);
